...
public class MemoizedScalarRungeKutta4Test {
    ...
    public void testSolution(BiFunction<Double, Double, Double> dx, Function<Double, Double> xExp, double xi, double ti) {
        ...
        Function<Double, Double> xAct = MemoizedScalarRungeKutta4.Builder.builder()
                .setStepSize(0.009)
                .build()
                .solution(dx, xi, ti);
    ...
    public void testMotion(Function<Double, Double> xExp, double a, double vi, double xi, double ti) {
        // Velocity function
        Function<Double, Double> v = MemoizedScalarRungeKutta4.Builder.builder()
                .setStepSize(0.1)
                .build()
                .solution((vel, t) -> a, vi, ti);
        // Position function
        Function<Double, Double> x = MemoizedScalarRungeKutta4.Builder.builder()
                .setStepSize(0.1)
                .build()
