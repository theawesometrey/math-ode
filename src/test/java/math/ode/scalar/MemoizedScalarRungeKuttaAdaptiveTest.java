...
public class MemoizedScalarRungeKuttaAdaptiveTest {
    ...
    public void testSolution(BiFunction<Double, Double, Double> dx, Function<Double, Double> xExp, double xi, double ti) {
        Function<Double, Double> xAct = MemoizedScalarRungeKuttaAdaptive.Builder.builder()
    ...
    public void testMotion(Function<Double, Double> xExp, double a, double vi, double xi, double ti) {
        // Velocity function
        Function<Double, Double> v = MemoizedScalarRungeKuttaAdaptive.Builder.builder()
                .setInitialStepSize(0.1)
                .build()
                .solution((vel, t) -> a, vi, ti);
        // Position function
        Function<Double, Double> x = MemoizedScalarRungeKuttaAdaptive.Builder.builder()
                .setInitialStepSize(0.1)
                .build()
